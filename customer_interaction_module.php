<?php
/**
 * customer_interaction_module.php
 *
 ...
 * page that lists customers (customers.php, customer_details.php,
 * customer_form.php, etc.) without depending on anything prospect
 * specific.
 *
...
/**
 * Statuses selectable from the "Status Change" interaction type.
 */
