...
<nav class="menubar card">
  <div class="menubar-inner">
    ...
    <?php render_menu_dropdown('Customers', [
      ...
      ['href' => 'crm.php', 'file' => 'crm.php', 'label' => 'CRM'],
    ], $current); ?>
...
<aside id="leftQuickAccessPanel" class="left-quick-access-panel" aria-hidden="true">
  ...
  <a class="left-quick-access-link <?= $current === 'crm.php' ? 'active' : '' ?>" href="crm.php">CRM</a>
...
?>
  <nav class="footer-nav" aria-label="Secondary navigation">
    <div class="footer-nav-inner">
      ...
      <a class="footer-nav-link <?= $fc === 'crm.php' ? 'active' : '' ?>" href="crm.php">CRM</a>
