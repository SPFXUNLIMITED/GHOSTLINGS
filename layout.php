...
<nav class="menubar card">
  <div class="menubar-inner">
    ...
    <?php render_menu_dropdown('RFQ & Sourcing', [
      ...
      ['href' => 'rfq_form.php', 'file' => 'rfq_form.php', 'label' => 'Sourcing RFQ Form', 'visible' => $show_rfq_menu],
      ['href' => 'rfq_tracker.php', 'file' => 'rfq_tracker.php', 'label' => 'Sourcing RFQ Tracker', 'visible' => $show_rfq_menu],
